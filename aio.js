...
// This script performs a sequence of 7 tasks, repeats 10 times with an interval,
...
const RUN_INTERVAL_MS = (INTERVAL_HOURS * 60 + INTERVAL_MINUTES) * 60 * 1000;
...
async function task_bridgeTokens() {
    ...
    await sendSubtask(
        ...
        ''
    );
}
...
async function scheduleDailyRuns() {
    ...
    console.log(`Interval between sequences: ${INTERVAL_HOURS}h ${INTERVAL_MINUTES}m.`);
    ...
    while (true) {
        ...
        for (let i = 1; i <= RUNS_PER_SESSION; i++) {
            ...
            if (i < RUNS_PER_SESSION) {
                console.log(`\n...Waiting for the next sequence. See you in ${INTERVAL_HOURS}h ${INTERVAL_MINUTES}m...`);
